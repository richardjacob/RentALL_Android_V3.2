...
import com.rentall.radicalstart.adapter.LanguagesAdapter
...
class LanguagesDialog : BaseDialogFragment() {
    ...
    val viewModel: LanguagesViewModel
        get() = ViewModelProviders.of(this, mViewModelFactory).get(LanguagesViewModel::class.java)
